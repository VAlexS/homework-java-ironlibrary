...
public class IronlibraryApplication {
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context = SpringApplication.run(IronlibraryApplication.class, args);

        // Get the IronlibraryApplication bean from the context
        IronlibraryApplication app = context.getBean(IronlibraryApplication.class);
